...
```bash
git clone https://github.com/itsakarya/YCDirectory.git
cd YCDirectory
```
...
- [Figma](https://www.figma.com/design/TMGW6rLGene3cqHb4Kilz5/Pitch-Startup-App?node-id=62001-5376&t=VNGPCKxvFghhi3W0-0)
